...
namespace airlib
{
    ...
    public: //these APIs uses above low level APIs
        ...
        virtual bool moveOnPathWithGimbalPose(const vector<Vector3r>& path, const vector<Pose>& drone_poses,float velocity, vector<Pose>& poses, float timeout_sec, DrivetrainType drivetrain, const YawMode& yaw_mode,
        ...
        EulerAngles toEulerAngles(Quaternionr q) {
            EulerAngles angles;
