...
namespace airlib
{
    ...
    public:
        ...
        //Rotate turbine
        virtual double getRotateTurbineAngle(const std::string turbine_label) =0;
        virtual void setEnableTurbineRotate(const std::string turbine_name,const bool en) =0;

        virtual  std::vector<std::string> listRotateTurbines() =0;
        virtual  msr::airlib::RotateTurbineState getRotateTurbineState(const std::string turbine_name) =0;
        //end Rotate Turbine
