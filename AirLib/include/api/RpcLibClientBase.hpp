...
namespace airlib
{
    ...
    public:
        ...
        //Rotate Turbine
        double simGetRotateTurbineAngle(const std::string& object_name);
        void simSetEnableTurbineRotate(const std::string object_name, const bool en);
        std::vector<std::string> simListRotateTurbines();
        msr::airlib::RotateTurbineState simGetRotateTurbineState(const std::string& object_name);
