...
public:
    ...
    typedef msr::airlib::RotateTurbineState RotateTurbineState;
    virtual void getRotateTurbineActors(TArray<AActor*>& turbines) const;

    virtual void enableTurbineRotate(bool en) const;

    virtual RotateTurbineState getRotateTurbineState(const std::string& turbine_name) const;
