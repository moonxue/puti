...
public:
    ...
    //Rotate Turbine
    virtual double getRotateTurbineAngle(const std::string turbine_name) override;
    virtual void setEnableTurbineRotate(const std::string turbine_name,const bool en) override;
    virtual std::vector<std::string> listRotateTurbines() override;
    virtual  msr::airlib::RotateTurbineState getRotateTurbineState(const std::string turbine_name) override;
